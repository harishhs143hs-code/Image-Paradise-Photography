document.addEventListener('DOMContentLoaded',()=>{
  ...
  manifesto.innerHTML=`
    <div><div class="xp-kicker">The Image Paradise approach</div><div class="xp-rule"></div></div>
    <div><h2 id="xp-manifesto-title">Your day, told with <em>intention.</em></h2><p class="xp-manifesto-copy">From the quiet details to the loudest celebrations, we document the atmosphere, people and emotions that make your story yours. Explore our work, discover the experience, then tell us what you are planning.</p></div>`;
  ...
  faq.id='xp-faq';
  faq.innerHTML=`<div class="xp-faq-head"><div><div class="xp-kicker">Before we begin</div></div><div><h2>Frequently <em>asked.</em></h2><p class="xp-faq-intro">A few quick answers before you plan your session.</p></div></div><div class="xp-faq-list">
    <div class="xp-faq-item"><button class="xp-faq-q" type="button" aria-expanded="false"><span>What areas do you cover?</span><span>+</span></button><div class="xp-faq-a">We are based in Chennai and cover weddings and portrait sessions across Tamil Nadu, with travel available for celebrations beyond the region.</div></div>
    <div class="xp-faq-item"><button class="xp-faq-q" type="button" aria-expanded="false"><span>Can we customise a package?</span><span>+</span></button><div class="xp-faq-a">Yes. Tell us your event type, coverage needs and priorities through the enquiry form and we can discuss the right combination of photography, films and albums.</div></div>
    <div class="xp-faq-item"><button class="xp-faq-q" type="button" aria-expanded="false"><span>How do we enquire?</span><span>+</span></button><div class="xp-faq-a">Use the enquiry form, WhatsApp or the booking button. Share your date and event details and the team can take it from there.</div></div>
  </div>`;
